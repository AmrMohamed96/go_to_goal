...
flag_send = 0
    #Publishers
cmd_vel_publisher1 = rospy.Publisher('cmd_vel_rob2', Twist, queue_size = 5)
cmd_vel_publisher2 = rospy.Publisher('gtg_flag_rob2',Int32 , queue_size = 5)
...
def gtg_talker():
    rospy.init_node('go_to_goal2')
    rospy.loginfo("%s started" % rospy.get_name())
    #print("talker")
    #Subscribers
    rospy.Subscriber('rob2_CurrentPose', Int32MultiArray,Robot2)
    rospy.Subscriber('Planning_Output2', Int32MultiArray, goal2)
    #Publishing Rate
    rate = rospy.Rate(10)
